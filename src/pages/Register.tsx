  ...
  return (
    <div className="min-h-screen flex">
      ...
      <motion.div
        ...
        className="relative w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12 bg-[#FAF4EA]"
      >
        ...
        <div className="w-full max-w-lg">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="font-display text-3xl font-bold mb-2 text-[#0B0B0B]">{t('auth.createAccount')}</h1>
          ...
          >
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-[#0B0B0B]" htmlFor="location">
                {t('auth.location', 'Location (District, State)')}
              </label>
              <div className="relative">
