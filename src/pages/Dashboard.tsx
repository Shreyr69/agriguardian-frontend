  ...
  const quickActions = [
    {
      ...
      description: t('dashboard.quickActionDescs.identifyDesc'),
      icon: Bug,
      href: "/identify",
      color: "bg-[#B9F261]",
    ...
    },
    {
      ...
      description: t('dashboard.quickActionDescs.chatDesc'),
      icon: MessageCircle,
      href: "/chat",
      color: "bg-[#FFD24A]",
      iconColor: "text-[#0B0B0B]"
    },
    {
      ...
      description: t('dashboard.quickActionDescs.alertsDesc'),
      icon: Bell,
      href: "/alerts",
      color: "bg-orange-400",
      iconColor: "text-[#0B0B0B]"
    },
    {
      ...
      description: t('dashboard.quickActionDescs.sprayLogDesc'),
      icon: ClipboardList,
      href: "/spray-log",
    ...
    },
    {
      ...
      description: t('dashboard.quickActionDescs.communityDesc'),
      icon: Users,
      href: "/community",
      color: "bg-sky-400",
      iconColor: "text-[#0B0B0B]"
                    ...
                    <CardContent className="relative z-10">
                      <div className="flex items-end justify-between mb-4">
                        <div>
                          ...
                          <p className="text-sm text-[#0B0B0B]/70 flex items-center gap-1 mt-1">
                            ...
                            {t(`dashboard.weatherConditions.${weatherData.condition.split(' ')[0]}`, weatherData.condition)}
                          </p>
                        </div>
                      ...
                      <div className="p-3 rounded-xl bg-white/90 backdrop-blur-sm border border-white/50 flex items-start gap-2 shadow-sm">
                        ...
                        <p className="text-sm text-[#0B0B0B]/80">
                          {weatherData.warning || t('dashboard.weatherClickHint')}
                        </p>
                      </div>
                    </CardContent>
                  </Card>
